...
系统 SHALL 在市场页顶部 VIX 区域下方展示固定跟踪清单的“距历史最高点回撤”列表。列表 MUST 至少覆盖以下标的：Bitcoin、DAX、Dow Jones Industrial Average、FTSE All-World、Gold、MSCI World、Nasdaq Composite、Nasdaq-100、Nikkei 225、S&P 500、SMI。每项 SHALL 展示名称、最近一次历史最高点日期、当前相对历史最高点的跌幅，以及状态标记。
