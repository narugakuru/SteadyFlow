...
| transactions       | 交易记录       | accountId(FK), holdingId(FK可选), type(buy/sell/dividend/deposit/withdraw/fee), date, amount, realizedPnl(单笔了结盈亏，账户原币种), cashDelta, principalDelta, holdingSharesDelta, holdingCostDelta, holdingMarketValueDelta, shares, price, fee, affectCash(影响现金, 0/1), affectHolding(影响持仓, 0/1) |
