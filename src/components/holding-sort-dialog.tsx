...
function SortableHoldingRow({ item }: { item: HoldingSortItem }) {
  ...
  return (
    <div
      ...
      className={`grid grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)_minmax(0,1fr)_5.25rem] gap-2 items-center rounded-md border px-3 py-2 ${
...
export function HoldingSortDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[min(96vw,42rem)] md:max-w-2xl">
        <DialogHeader>
